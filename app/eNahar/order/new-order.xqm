...
:)
declare %private function new-order:ordersToRows($uid as xs:string, $roles, $orders)
{
...
declare variable $new-order:cal-infos-uri       := "/exist/apps/eNahar/cal/cal-infos.xml";
declare variable $new-order:restxq-orders       := "/exist/restxq/nabu/orders";
declare variable $new-order:order-infos-uri     := "/exist/apps/nabu/FHIR/Order/order-infos.xml";
declare variable $new-order:restxq-encounters := "/exist/restxq/nabu/encounters";
declare variable $new-order:restxq-services     := "/exist/restxq/metis/roles?filter=service";
declare variable $new-order:restxq-patients     := "/exist/restxq/nabu/patients";
declare variable $new-order:restxq-metis-users-ref  := "/exist/restxq/metis/PractitionerRole/users?_format=ref";
...
-->    
        ...
        <xf:submission id="s-search"
                ...
                instance='i-all' 
                replace="instance">
            <xf:resource value="concat('{$new-order:restxq-orders}','?loguid=',encode-for-uri(instance('i-login')/*:loguid),'&amp;lognam=',encode-for-uri(instance('i-login')/*:lognam),'&amp;realm=',encode-for-uri(instance('i-login')/*:realm))"/>
			<xf:header>
...
('choices')/choice[. = instance('criteria_data')/criteria/set/criterion]/../root">      
        ...
        <xf:submission id="s-get-groups"
					...
					method="get"
					replace="instance"
					resource="{$new-order:restxq-services}">
			<xf:header>
                <xf:name>Content-Type</xf:name>
                <xf:value>application/xml</xf:value>
            </xf:header>
        ...
        <xf:submission id="s-get-users"
					...
					method="get"
					replace="instance"
					resource="{$new-order:restxq-metis-users-ref}">
			<xf:header>
                <xf:name>Content-Type</xf:name>
                <xf:value>application/xml</xf:value>
            </xf:header>
        ...
        <xf:instance id="i-calInfos" xmlns="" src="{$new-order:cal-infos-uri}"/>
        <xf:instance id="i-o-infos"  xmlns="" src="{$new-order:order-infos-uri}"/>
    ...
    <xf:group id="dashboard">
        <xf:switch>
            <xf:case id="listOrders">
                    ...
                    { new-order:mkOrderListGroup() }
                    { new-order:mkOrderListTriggerGroup() }
            </xf:case>
...
declare %private function new-order:mkOrderListGroup()
{
    <div>
        <table class="">
            <thead>
...
declare %private function new-order:mkOrderListTriggerGroup()
{
    <table>
        <tr>
            <td>
