    ...
    )
{
    system:as-user('vdba', 'kikl823!',
            (
              ...
              :)
             update value $ct/fhir:statusHistory/fhir:extension[@url='#eoc-workflow-change']/fhir:valueCodeableConcept/fhir:coding/fhir:system/@value  with 'http://eNahar.org/nabu/system#eoc-workflow-change-reason'
