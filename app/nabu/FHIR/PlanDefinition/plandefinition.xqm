xquery version "3.0";
module namespace plandef = "http://enahar.org/exist/apps/nabu/plandef";
...
import module namespace r-careplan = "http://enahar.org/exist/restxq/nabu/careplans" at "/db/apps/nabu/FHIR/Task/careplan-routes.xqm";
...
declare function plandef:fillTemplate()
{
 ()
};
