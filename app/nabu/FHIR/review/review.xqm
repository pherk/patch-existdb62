...
module namespace review = "http://enahar.org/exist/apps/nabu/review";
...
declare variable $review:restxq-conditions := "/exist/restxq/nabu/conditions";
declare variable $review:restxq-patients   := "/exist/restxq/nabu/patients";
declare variable $review:con-infos-uri     := "/exist/apps/nabu/FHIR/Condition/condition-infos.xml";
...
(:~
 ...
 : @return html
 :)
declare function review:tagged($tag as xs:string) as item()*
{
    let $realm  := "kikl-spzn"
...
(<div style="display:none;">
    ...
    <xf:model id="model">
        ...
        <xf:submission id="s-get-cons"
                ...
                instance='i-cons' 
                replace="instance">
            <xf:resource value="concat('{$review:restxq-conditions}','?loguid=',encode-for-uri('{$uid}'),'&amp;lognam=',encode-for-uri('{$unam}'),'&amp;realm=',encode-for-uri('{$realm}'))"/>
			<xf:header>
