...
, exrest:register-module(xs:anyURI('/db/apps/eNahar/order/wk-routes.xqm'))

, exrest:register-module(xs:anyURI('/db/apps/terminology/claml/claml-routes.xqm'))

, exrest:register-module(xs:anyURI('/db/apps/golem/modules/plan-routes.xqm'))
, exrest:register-module(xs:anyURI('/db/apps/golem/modules/test-routes.xqm'))
