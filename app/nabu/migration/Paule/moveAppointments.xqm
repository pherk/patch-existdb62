...
import module namespace r-appointment  = "http://enahar.org/exist/restxq/nabu/appointments"   at "/db/apps/nabu/FHIR/Appointment/appointment-routes.xqm";
...
let $osh := $history/fhir:Appointment
...
let $store  := r-appointment:putAppointment(<content>{$new}</content>, $realm, $loguid, $lognam)
return
    ()