...
(:~
 ...
 : within a module.
 :)
module namespace config="http://enahar.org/exist/apps/nabu/config";
...
declare variable $config:app-path    := 'exist/apps/nabu';
...
;
declare variable $config:history-data := "/db/apps/nabuHistory/data";
declare variable $config:com-data     := '/db/apps/nabuCom/data';
declare variable $config:metis-root   := "/db/apps/metis";

declare variable $config:nabu-imports   := concat($config:nabu-root,'/import');


declare variable $config:nabu-meetings  := concat($config:nabu-root,   '/meetings');
declare variable $config:nabu-patients  := concat($config:nabu-root,   '/FHIR/Patients');
declare variable $config:nabu-orders       := concat($config:nabu-root,'/FHIR/Orders');
declare variable $config:nabu-appointments := concat($config:nabu-root,'/FHIR/Appointments');
declare variable $config:nabu-encounters   := concat($config:nabu-root,'/FHIR/Encounters');

declare variable $config:nabu-resources := concat($config:nabu-root,'/resources');
declare variable $config:nabu-templs    := concat($config:nabu-root,'/templates');
