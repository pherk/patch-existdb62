...
(:~
 ...
 : within a module.
 :)
module namespace config="http://enahar.org/exist/apps/nabudocs/config";
...
declare variable $config:app-path    := 'exist/apps/nabudocs';
declare variable $config:redirectURL := concat($config:server,'/',$config:app-path,'/admin.html');
...
declare variable $config:nabu-data-collections :=
    (   
        '/FHIR/Communications'
    );
