...
(: 
 ...
 : templating.
 :)
import module namespace config ="http://enahar.org/exist/apps/nabudocs/config" at "config.xqm";
import module namespace app    ="http://enahar.org/exist/apps/nabudocs" at "app.xqm";
(: 
