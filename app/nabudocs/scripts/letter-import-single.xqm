...
let $import-date := "2022-12-01"
let $import-folder := "Befunde2022"

(: below nothing to change :)
...
let $fhir-base   := "/db/apps/nabuComposition/data"
...
:)
for $l in xmldb:find-last-modified-since($letters,xs:dateTime(concat($import-date, "T00:00:00")))[matches(.,'Richrath')]
